...
class MicroMouseNode : public rclcpp::Node {
 public:
  MicroMouseNode() : Node("micromouse_node") {
    ...
    this->declare_parameter("path_color", "c");
    this->declare_parameter("goal_color", "r");
    this->declare_parameter("standalone_mode", false);

    // 2. Retrieve parameters into member variables
    ...
    // Special handling for chars: retrieve as string, take 0th index
    ...
    robot_position_pub_ = this->create_publisher<geometry_msgs::msg::Point>("/robot_position", 10);
    // =====================================================================
    // YOUR CODE HERE
    ...
    status_srv_ = this->create_service<GetRobotStatus>(
        "/get_robot_status",
        std::bind(&MicroMouseNode::get_status_callback, this, std::placeholders::_1, std::placeholders::_2));
    // =====================================================================
    ...
    // YOUR CODE HERE
      ...
      RCLCPP_INFO(this->get_logger(),
                  "NavigateToGoal action server started on '/navigate_to_goal'");
