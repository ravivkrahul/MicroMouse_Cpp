...
void NavigateActionClient::send_goal() {
  ...
  send_goal_options.goal_response_callback =
        std::bind(&NavigateActionClient::goal_response_callback, this, _1);

  send_goal_options.feedback_callback =
        std::bind(&NavigateActionClient::feedback_callback, this, _1, _2);

  send_goal_options.result_callback =
        std::bind(&NavigateActionClient::result_callback, this, _1);
  // Send the goal
...
void NavigateActionClient::feedback_callback(
  ...
  // YOUR CODE HERE
    ...
    RCLCPP_INFO(this->get_logger(),
                "Feedback - Position: (%d, %d), Direction: %d, Elapsed: %.2f s",
                feedback->current_x,
                feedback->current_y,
                feedback->direction,
